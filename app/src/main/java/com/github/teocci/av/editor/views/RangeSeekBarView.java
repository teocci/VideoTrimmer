...
public class RangeSeekBarView extends View
{
    ...
    public void initMaxWidth()
    {
        ...
        onSeekStop(this, 0, mThumbs.get(0).getValue());
        onSeekStop(this, 1, mThumbs.get(1).getValue());
    }
    ...
    public boolean onTouchEvent(MotionEvent ev)
    {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                onSeekStart(this, currentThumb, mThumb.getValue());
                return true;
            }
            case MotionEvent.ACTION_UP: {
                ...
                mThumb = mThumbs.get(currentThumb);
                onSeekStop(this, currentThumb, mThumb.getValue());
                return true;
            }
    ...
    private void calculateThumbValue(int index)
    {
        if (index < mThumbs.size() && !mThumbs.isEmpty()) {
            ...
            th.setValue(pixelToScale(index, th.getPos()));
            onSeek(this, index, th.getValue());
        }
    }
    ...
    private void calculateThumbPos(int index)
    {
        if (index < mThumbs.size() && !mThumbs.isEmpty()) {
            Thumb th = mThumbs.get(index);
            th.setPos(scaleToPixel(index, th.getValue()));
        }
    }
    ...
    {
        return mThumbs.get(index).getValue();
    }

    public void setThumbValue(int index, float value)
    {
        mThumbs.get(index).setValue(value);
